...
public interface ISuCaiFlowEngineSiteCollector {
    ...
    /// 异步解析页面获取资源URL列表
    /// </summary>
    /// <param name="descriptor">采集任务</param>
    /// <param name="pageUrl">页面URL</param>
    /// <param name="cancellationToken"></param>
    /// <returns>资源URL列表</returns>
    Task<IEnumerable<string>> ParsePageAsync(SuCaiFlowTaskDescriptor descriptor, string pageUrl, CancellationToken cancellationToken);
    ...
    string PreprocessAssetUrl(string url);
}
