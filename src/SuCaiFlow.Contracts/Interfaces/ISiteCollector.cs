...
public interface ISiteCollector {
    ...
    Task<IEnumerable<string>> ParsePageAsync(CollectionTask task, string pageUrl, CollectionTaskConfig? config = null);
    ...
    Task<CollectedAsset?> DownloadAssetAsync(string url, CollectionTaskConfig? config = null);
